...
function StudentMaterialsCheck() {
    ...
    const loggedInUser = currentUser?.full_name || currentUser?.name || currentUser?.email || 'Danny niyitanga';
    ...
    const fetchInitialData = async () => {
        try {
            ...
            const classRes = await fetch('https://kass-checking-backend.vercel.app/api/v1/classes');
    ...
    const fetchStudentsAndMaterials = async () => {
        try {
            setLoading(true);
            const studRes = await fetch(`https://kass-checking-backend.vercel.app/api/v1/get-students-materials?class=${encodeURIComponent(selectedClass)}&term=${selectedTerm}`);
    ...
    const handleSaveAll = async (e) => {
        ...
        try {
            ...
            const promises = materials.map(mat => {
                ...
                return fetch('https://kass-checking-backend.vercel.app/api/v1/check-materials', {
                    method: 'POST',
                        ...
                        <form onSubmit={handleSaveAll}>
                            ...
                            <div className="form-action-footer">
                                <div className="logged-in-badge">
                                    Checking as: <strong>{loggedInUser}</strong>
                                </div>
