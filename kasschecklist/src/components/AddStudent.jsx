...
export default function AddStudent({ onStudentAdded }) {
  ...
  const handleManualSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://kass-checking-backend.vercel.app/api/v1/student', { 
  ...
  const handleExcelSubmit = async (e) => {
    ...
    try {
      await axios.post('https://kass-checking-backend.vercel.app/api/v1/students/upload-excel', formData, {
