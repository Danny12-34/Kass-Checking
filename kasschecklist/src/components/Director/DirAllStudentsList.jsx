...
import Sidebar from './DirectoerSidebar'; // Import your Sidebar component

export default function DirStudentsList() {
    ...
    <>
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          /* Convert table layout to responsive card blocks */
          .styled-table thead {
            display: none;
          }
          ...
          .pagination-numbers {
            max-width: 180px; /* Limits number display width on small screens */
          }
        }
      `}</style>
      ...
      <div className="layout-flex">
        ...
        <div className="main-content">
          <div className="students-container">
                ...
                <tbody>
                  {currentStudents.length === 0 ? (
                    ...
                    currentStudents.map((student, index) => (
                      <tr key={student.id}>
                        <td data-label="#" style={{ color: '#64748b', fontWeight: '500' }}>
                          {indexOfFirstItem + index + 1}
                        </td>
                        <td data-label="Reg Number" style={{ fontWeight: '600', color: '#0f172a' }}>
                          {student.reg_number}
                        </td>
            ...
            {/* Fully Responsive Pagination Footer */}
